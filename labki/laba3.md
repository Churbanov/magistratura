...
- [ ] мы попробовали два интерфейса управления: если необходимо достаточно быстро и беспроблематично установить, то это, конечно, же Kinematic, но Portainer предоставляет больше возможностей своему юзеру.
